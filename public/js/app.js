...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AppWatcher_Core_resources_assets_js_components_bus__ = __webpack_require__(57);
...
window.Bus = __WEBPACK_IMPORTED_MODULE_0__AppWatcher_Core_resources_assets_js_components_bus__["a" /* default */];
var app = new Vue({
  el: '#app',
  data: {
    Bus: window.Bus
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-31d01ce7", Component.options)
  } else {
    hotAPI.reload("data-v-31d01ce7", Component.options)
' + '  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-31d01ce7", module.exports)
  }
}
